...
const BottomSheet = forwardRef<HTMLDivElement, Props>(({ close, apply, skip, address, alias, onAliasChange }, ref) => {
  ...
  const handleSkip = (e: React.MouseEvent) => {
    e.stopPropagation(); // prevent the click event from bubbling up to the overlay
    skip(); // close the BottomSheet when the close button is clicked
  };
